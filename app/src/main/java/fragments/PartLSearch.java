 ...
 */
public class PartLSearch extends Fragment {
    ...
    public void updateAdapter(GetPartListByOrderIdData searchData) {
        ...
        if (searchData != null) {
            searchAdapter = new SearchAdapter(getActivity(), searchData.getData().getPartlabour());
    ...
    public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.MyViewHolder> {
        ...
        List<GetPartListByOrderIdData.DataBean.PartlabourBean> arrCategoryList;
        ...
        public SearchAdapter(Activity activity, List<GetPartListByOrderIdData.DataBean.PartlabourBean> arrCategoryList) {
