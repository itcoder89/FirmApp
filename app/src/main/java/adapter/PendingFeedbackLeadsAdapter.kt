...
class PendingFeedbackLeadsAdapter(var cxt: FragmentActivity?) :
    RecyclerView.Adapter<PendingFeedbackLeadsAdapter.ViewHolder>() {

    var feedData: ArrayList<PendingFeedbackListData.DataBean>? = ArrayList()

    var onItemClick: ((pos: Int, view: View) -> Unit)? = null

    fun addData(listItems: List<PendingFeedbackListData.DataBean>) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val v = LayoutInflater.from(parent.context)
            .inflate(R.layout.all_pending_feedback_item_layout, parent, false)
        return ViewHolder(v)
    }
